<x-app-layout>
    <section x-data="{
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    <h2 class="text-lg font-medium text-gray-800 dark:text-white">ادارة المستعملين</h2>
                </div>
            </div>
        ...
        <div class="mt-6 md:flex md:items-center md:justify-between ">
            <x-user-modal class="flex items-center mt-4 md:mt-0 ">
                <x-slot name="trigger">
                ...
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody x-ref="tbody" class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <h4 class="text-gray-700 dark:text-gray-200">
                                                <span class="inline px-3 py-1 text-sm rounded-full {{ $user->role === 'admin' ? 'text-red-500 bg-red-100': 'text-emerald-500 bg-emerald-100' }}">
                                                    {{ $user->role ==='admin' ? 'مدبر نظام' : '' }}
                                                    {{ $user->role ==='parquet' ? 'نيابة عامة' : '' }}
                                                    {{ $user->role ==='president' ? 'رئاسة' : '' }}
                                                </span>
                                            </h4>
